...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_KennedyS')
	 Begin 
	  Alter Database [Assignment06DB_KennedyS] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_KennedyS;
	 End
	Create Database Assignment06DB_KennedyS;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_KennedyS;
...
-- Deny SELECT permission on each table
Deny Select on dbo.Categories to public;
Deny Select on dbo.Products to public;
Deny Select on dbo.Employees to public;
Deny Select on dbo.Inventories to public;

-- Grant SELECT permission on each view
...
As
	...
	Inner Join dbo.Employees e on i.EmployeeID = e.EmployeeID
...
As
	...
	Inner Join dbo.Inventories i on p.ProductID = i.ProductID
...
As
	...
	Order By c.CategoryName, p.ProductName, i.InventoryID, e.EmployeeFirstName;
go
